...
GITHUB_API = "https://api.github.com/repos/tenstorrent/tt-mlir/compare"
GITHUB_DIFF = "https://github.com/tenstorrent/tt-mlir/compare"
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python mlir_commit_range.py <from_commit> <to_commit>")
        sys.exit(1)
    ...
    for commit in commits:
        print(f"{commit['date']},{commit['hash']},{commit['author']},\"{commit['message']}\",https://github.com/tenstorrent/tt-mlir/commit/{commit['longsha']}")
